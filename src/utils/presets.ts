import { Preset, FilterSettings, RGBShift } from "../types"
...
export const PRESETS: Preset[] = [
  {
    ...
    effects: { grain: 0, vignette: 0, rgbSplit: 0, pixelate: 0, bloom: 0, glow: 0 },
    style: "normal"
  },
  {
    name: "Digicam",
    ...
    effects: { grain: 30, vignette: 40, rgbSplit: 10, pixelate: 0, bloom: 0, glow: 0 },
    style: "y2k"
  },
  {
    name: "Y2K Aesthetic",
    ...
    effects: { grain: 15, vignette: 0, rgbSplit: 25, pixelate: 0, bloom: 0, glow: 0 },
    style: "y2k"
  },
  {
    name: "Goth Dark",
    ...
    effects: { grain: 50, vignette: 80, rgbSplit: 0, pixelate: 0, bloom: 0, glow: 0 },
    style: "goth"
  },
  {
    name: "Goth Noir",
    ...
    rgbShift: { r: 0, g: 0, b: 0 },
    effects: { grain: 60, vignette: 90, rgbSplit: 0, pixelate: 0, bloom: 0, glow: 0 },
    style: "goth"
  },
  {
    name: "Emo Purple",
    ...
    effects: { grain: 35, vignette: 50, rgbSplit: 15, pixelate: 0, bloom: 0, glow: 0 },
    style: "emo"
  },
  {
    name: "Emo Red",
    ...
    effects: { grain: 40, vignette: 60, rgbSplit: 20, pixelate: 0, bloom: 0, glow: 0 },
    style: "emo"
  },
  {
    name: "Glitch Core",
    ...
    effects: { grain: 20, vignette: 0, rgbSplit: 50, pixelate: 2, bloom: 30, glow: 10 },
    style: "y2k"
  },
  {
    name: "Pixel Dreams",
    ...
    rgbShift: { r: 0, g: 0, b: 0 },
    effects: { grain: 10, vignette: 20, rgbSplit: 0, pixelate: 8, bloom: 10, glow: 5 },
    style: "y2k"
  }
]
